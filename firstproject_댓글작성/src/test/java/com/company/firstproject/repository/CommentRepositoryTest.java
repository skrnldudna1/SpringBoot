...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        Comment a = new Comment(1L, article, "Park", "그 왜 허팝");
        Comment b = new Comment(2L, article, "Choi", "쇼생크 탈출");
    ...
    void findByNickname() {
        ...
        Comment a = new Comment(1L, new Article(4L, "당신의 인생 영화는?", "댓글 고"),
                nickname, "굿 윌 헌팅");
        Comment b = new Comment(3L, new Article(5L, "당신의 소울 푸드는?", "댓글 고고"),
                nickname, "치킨");
        Comment c = new Comment(6L, new Article(6L, "당신의 취미는?", "댓글 고고고"),
                nickname, "조깅");
